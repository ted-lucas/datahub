...
/// Geometry is stored as SQL Server <c>geography</c> when present.
/// </summary>
public class Country : AuditableEntity
{
    /// <summary>ISO 3166-1 alpha-2 code, e.g. "US".</summary>
    ...
    /// <summary>Country polygon / multipolygon. May be null if not yet loaded.</summary>
